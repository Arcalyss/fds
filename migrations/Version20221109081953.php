 ...
 */
final class Version20221109081953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE serie CHANGE resume resume LONGTEXT NOT NULL, CHANGE duree duree TIME NOT NULL, CHANGE premiereDiffusion premiereDiffusion DATE NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
    }
